...
plot(climate_hotpots, col = hotspot_cols, legend = F); map('world', fill = T, add = T, col = 'gray80')
...
plot(fishing_hotpots, col = hotspot_cols, legend = F); map('world', fill = T, add = T, col = 'gray80')
